...
relacionales
	...
	| IDENTIFICADOR T_IGUAL T_IGUAL expresion	{$$= new Logi($1 +"=="+$4,"param");}	/* == */
	| IDENTIFICADOR T_IGUAL T_IGUAL IDENTIFICADOR {$$= new Logi($1 +"=="+$4,"param");}
	| IDENTIFICADOR T_IGUAL T_IGUAL T_TRUE {$$= new Logi($1 +"=="+$4,"param");}
	| IDENTIFICADOR T_IGUAL T_IGUAL T_FALSE {$$= new Logi($1 +"=="+$4,"param");}
	| IDENTIFICADOR T_IGUAL T_IGUAL CADENA {$$= new Logi($1 +"=="+$4,"param");}
	| IDENTIFICADOR T_IGUAL T_IGUAL CHAR {$$= new Logi($1 +"=="+$4,"param");}
	| IDENTIFICADOR T_DIFERENTE T_IGUAL expresion	{$$= new Logi($1 +"!="+$4,"param");}	/* != */
	| IDENTIFICADOR T_DIFERENTE T_IGUAL IDENTIFICADOR {$$= new Logi($1 +"!="+$4,"param");}
	| IDENTIFICADOR T_DIFERENTE T_IGUAL T_TRUE {$$= new Logi($1 +"!="+$4,"param");}
	| IDENTIFICADOR T_DIFERENTE T_IGUAL T_FALSE {$$= new Logi($1 +"!="+$4,"param");}
	| IDENTIFICADOR T_DIFERENTE T_IGUAL CADENA {$$= new Logi($1 +"!="+$4,"param");}
	| IDENTIFICADOR T_DIFERENTE T_IGUAL CHAR {$$= new Logi($1 +"!="+$4,"param");}
